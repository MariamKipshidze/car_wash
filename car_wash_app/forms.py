...
from .models import Location, Coupon, WashType, CompanyCarType, Branch
...
class CompanyCarTypeForm(forms.ModelForm):
    class Meta:
        model = CompanyCarType
        fields = ["car_type", "washing_cost"]
